...
try:
  ...
  if action == "":
    ...
    #Parameter -> Action: set_attributes
    #Parameter -> entity_id
    ...
    #Parameter -> Action: set_state_attributes
    #Parameter -> entity_id
    #Parameter -> state
    #Parameter -> attributes (list)
    #Parameter -> log_enabled
    ...
    log_error(logger, "**Invalid action provided ('{}').**\n\nExpected: 'set_state', 'set_attributes', 'set_state_attributes'.".format(action))
