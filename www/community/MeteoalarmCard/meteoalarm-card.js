...
var common = {
	...
	not_available: "Meteoalarm ist nicht verfügbar"
};
var error = {
...
var events = {
	...
	fog: "Nebel",
	hight_temperature: "Extrem hohe Temperaturen",
	low_temperature: "Extrem niedrige Temperaturen",
...
var events$2 = {
	...
	fog: "brouillard",
	hight_temperature: "température extrêmement élevée",
...
var events$4 = {
	...
	wind: "wind",
	snow_ice: "sneeuw/ijzel/bevriezing",
	thunderstorms: "onweer",
	fog: "mist",
	hight_temperature: "hitte",
	low_temperature: "koude",
	coastal_event: "kustbedreiging",
...
class MeteoalarmCardEditor extends LitElement {
...
class Data {
  static get events() {
    ...
    return [new Event$1('Forestfire', 'pine-tree-fire', 'events.forest_fire'), new Event$1('Avalanches', 'image-filter-hdr', 'events.avalanches'), new Event$1('Flood', 'home-flood', 'events.flood'), new Event$1('Rain-Flood', 'home-flood', 'events.rain_flood'), new Event$1('Coastal Event', 'waves', 'events.coastal_event'), new Event$1('Thunderstorms', 'weather-lightning', 'events.thunderstorms'), new Event$1('Rain', 'weather-pouring', 'events.rain'), new Event$1('Snow/Ice', 'weather-snowy-heavy', 'events.snow_ice'), new Event$1('Extreme high temperature', 'thermometer-chevron-up', 'events."hight_temperature'), new Event$1('Extreme low temperature', 'snowflake', 'events.low_temperature'), new Event$1('Wind', 'windsock', 'events.wind'), new Event$1('Fog', 'weather-fog', 'events.fog')];
  }

  static get levels() {
    return [new Level('Yellow', '#ff9800', 'messages.yellow'), new Level('Orange', '#EE5A24', 'messages.orange'), new Level('Red', '#db4437', 'messages.red')];
  }
...
class MeteoAlarmIntegration {
  ...
  static get eventTypes() {
    ...
    return [Data.getEventByName('Wind'), Data.getEventByName('Snow/Ice'), Data.getEventByName('Thunderstorms'), Data.getEventByName('Fog'), Data.getEventByName('Extreme high temperature'), Data.getEventByName('Extreme low temperature'), Data.getEventByName('Coastal Event'), Data.getEventByName('Forestfire'), Data.getEventByName('Avalanches'), Data.getEventByName('Rain'), Data.getEventByName('Flood'), Data.getEventByName('Rain-Flood')];
  }
...
class MeteoalarmCard extends LitElement {
  ...
  async attachObserver() {
    if (!this._resizeObserver) {
      this.resizeObserver = new index(debounce(() => this.measureCard(), 250, false));
    }
