 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const y=` ${n} `;class v{constructor(e,t,n,s){this.strings=e,this.values=t,this.type=n,this.processor=s}getHTML(){const e=this.strings.length-1;let t="",r=!1;for(let i=0;i<e;i++){const e=this.strings[i],o=e.lastIndexOf("\x3c!--");r=(o>-1||r)&&-1===e.indexOf("--\x3e",o+1);const a=c.exec(e);t+=null===a?e+(r?y:s):e.substr(0,a.index)+a[1]+a[2]+"$lit$"+a[3]+n}return t+=this.strings[e],t}getTemplateElement(){const e=document.createElement("template");return e.innerHTML=this.getHTML(),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(e,t,n,s){const r=t[0];if("."===r){return new M(e,t.slice(1),n).parts}return"@"===r?[new T(e,t.slice(1),s.eventContext)]:"?"===r?[new N(e,t.slice(1),n)]:new b(e,t,n).parts}handleTextExpression(e){return new P(e)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const Y=(e,...t)=>new v(e,t,"html",V)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
`;const qe=[["windsock","events.wind"],["snowflake","events.snow_ice"],["weather-lightning","events.thunderstorms"],["waves","events.fog"],["thermometer-chevron-up",'events."hight_temperature'],["snowflake","events.low_temperature"],["waves","events.coastal_event"],["pine-tree-fire","events.forest_fire"],["image-filter-hdr","events.avalanches"],["weather-pouring","events.rain"],["waves","events.flood"],["weather-pouring","events.rain_flood"]],Ie=[["#ff9800","messages.yellow"],["#EE5A24","messages.orange"],["#db4437","messages.red"]];customElements.define("meteoalarm-card",class extends K{static get properties(){return{hass:Object,config:Object,requestInProgress:Boolean}}static get styles(){return Re}static getStubConfig(e,t){const[n]=t.filter(e=>e.includes("meteoalarm"));return{entity:n||""}}get entity(){return this.hass.states[this.config.entity]}setConfig(e){if(!e.entity)throw new Error($e("error.missing_entity"));this.config=e}getCardSize(){return 2}shouldUpdate(e){return function(e,t,n){if(t.has("config")||n)return!0;if(e.config.entity){var s=t.get("hass");return!s||s.states[e.config.entity]!==e.hass.states[e.config.entity]}return!1}(this,e)}updated(e){e.get("hass")&&e.get("hass").states[this.config.entity].state!==this.hass.states[this.config.entity].state&&(this.requestInProgress=!1)}handleMore(){!function(e,t,n,s){s=s||{},n=null==n?{}:n;var r=new Event(t,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});r.detail=n,e.dispatchEvent(r)}(this,"hass-more-info",{entityId:this.entity.entity_id},{bubbles:!0,composed:!0})}getAttributes(e){const{status:t,state:n,friendly_name:s,event:r,headline:i,awareness_level:o,awareness_type:a}=e.attributes;let l={warning_active:"off"!=(t||n||e.state),friendly_name:s};return l.warning_active&&(l={...l,headline:r||i,awareness_level:Number(o.split(";")[0])-2,awareness_type:Number(a.split(";")[0])-1}),null==l.headline&&l.warning_active&&(l.headline=$e(Ie[l.awareness_level][1]).replace("{0}",$e(qe[l.awareness_type][1]))),l}getBackgroundColor(){const{warning_active:e,awareness_level:t}=this.getAttributes(this.entity);return e?Ie[t][0]:"inherit"}getFontColor(){const{warning_active:e}=this.getAttributes(this.entity);return e?"#fff":"--primary-text-color"}renderIcon(){let e="";if(this.entity){const{warning_active:t,awareness_type:n}=this.getAttributes(this.entity);e=t?qe[n][0]:"shield-outline"}else e="cloud-question";return Y`
			<ha-icon class="main-icon" icon="mdi:${e}"></ha-icon>
		`}renderStatus(){const{warning_active:e,headline:t}=this.getAttributes(this.entity);return e?Y`
				<div class="status"> 
					${t}
				</div> 
			`:Y`
				<div class="status"> 
					${$e("events.no_warnings")}
				</div> 
			`}render(){return this.entity?Y`
			<ha-card>
				<div 
					class="container"
			  ...
			  <ha-card>
				<div class="container">
					<div class="content"> 
						${this.renderIcon()}
						<div class="status"> 
							${$e("common.not_available")}
						</div>
					</div> 
				</div>
			  </ha-card>
			`}}),window.customCards=window.customCards||[],window.customCards.push({preview:!0,type:"meteoalarm-card",name:$e("common.name"),description:$e("common.description")});
