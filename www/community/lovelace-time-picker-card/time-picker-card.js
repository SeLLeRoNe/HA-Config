 ...
 */const w="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,x=(t,e,i=null)=>{for(;e!==i;){const i=e.nextSibling;t.removeChild(e),e=i}},C=`{{lit-${String(Math.random()).slice(2)}}}`,N=`\x3c!--${C}--\x3e`,P=new RegExp(`${C}|${N}`);class E{constructor(t,e){this.parts=[],this.element=e;const i=[],n=[],s=document.createTreeWalker(e.content,133,null,!1);let r=0,o=-1,a=0;const{strings:l,values:{length:c}}=t;for(;a<c;){const t=s.nextNode();if(null!==t){if(o++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:i}=e;let n=0;for(let t=0;t<i;t++)M(e[t].name,"$lit$")&&n++;for(;n-- >0;){const e=l[a],i=$.exec(e)[2],n=i.toLowerCase()+"$lit$",s=t.getAttribute(n);t.removeAttribute(n);const r=s.split(P);this.parts.push({type:"attribute",index:o,name:i,strings:r}),a+=r.length-1}}"TEMPLATE"===t.tagName&&(n.push(t),s.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(C)>=0){const n=t.parentNode,s=e.split(P),r=s.length-1;for(let e=0;e<r;e++){let i,r=s[e];if(""===r)i=A();else{const t=$.exec(r);null!==t&&M(t[2],"$lit$")&&(r=r.slice(0,t.index)+t[1]+t[2].slice(0,-"$lit$".length)+t[3]),i=document.createTextNode(r)}n.insertBefore(i,t),this.parts.push({type:"node",index:++o})}""===s[r]?(n.insertBefore(A(),t),i.push(t)):t.data=s[r],a+=r}}else if(8===t.nodeType)if(t.data===C){const e=t.parentNode;null!==t.previousSibling&&o!==r||(o++,e.insertBefore(A(),t)),r=o,this.parts.push({type:"node",index:o}),null===t.nextSibling?t.data="":(i.push(t),o--),a++}else{let e=-1;for(;-1!==(e=t.data.indexOf(C,e+1));)this.parts.push({type:"node",index:-1}),a++}}else s.currentNode=n.pop()}for(const t of i)t.parentNode.removeChild(t)}}const M=(t,e)=>{const i=t.length-e.length;return i>=0&&t.slice(i)===e},T=t=>-1!==t.index,A=()=>document.createComment(""),$=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function k(t,e){const{element:{content:i},parts:n}=t,s=document.createTreeWalker(i,133,null,!1);let r=V(n),o=n[r],a=-1,l=0;const c=[];let d=null;for(;s.nextNode();){a++;const t=s.currentNode;for(t.previousSibling===d&&(d=null),e.has(t)&&(c.push(t),null===d&&(d=t)),null!==d&&l++;void 0!==o&&o.index===a;)o.index=null!==d?-1:o.index-l,r=V(n,r),o=n[r]}c.forEach(t=>t.parentNode.removeChild(t))}const O=t=>{let e=11===t.nodeType?0:1;const i=document.createTreeWalker(t,133,null,!1);for(;i.nextNode();)e++;return e},V=(t,e=-1)=>{for(let i=e+1;i<t.length;i++){const e=t[i];if(T(e))return i}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const D=new WeakMap,U=t=>"function"==typeof t&&D.has(t),j={},H={};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const R=` ${C} `;class Y{constructor(t,e,i,n){this.strings=t,this.values=e,this.type=i,this.processor=n}getHTML(){const t=this.strings.length-1;let e="",i=!1;for(let n=0;n<t;n++){const t=this.strings[n],s=t.lastIndexOf("\x3c!--");i=(s>-1||i)&&-1===t.indexOf("--\x3e",s+1);const r=$.exec(t);e+=null===r?t+(i?R:N):t.substr(0,r.index)+r[1]+r[2]+"$lit$"+r[3]+C}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */"undefined"!=typeof window&&(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.2.1");const nt=(t,...e)=>new Y(t,e,"html",it)
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class xt{constructor(t){this.classes=new Set,this.changed=!1,this.element=t;const e=(t.getAttribute("class")||"").split(/\s+/);for(const t of e)this.classes.add(t)}add(t){this.classes.add(t),this.changed=!0}remove(t){this.classes.delete(t),this.changed=!0}commit(){if(this.changed){let t="";this.classes.forEach(e=>t+=e+" "),this.element.setAttribute("class",t)}}}const Ct=new WeakMap,Nt=(Pt=t=>e=>{if(!(e instanceof B)||e instanceof J||"class"!==e.committer.name||e.committer.parts.length>1)throw new Error("The `classMap` directive must be used in the `class` attribute and must be the only part in the attribute.");const{committer:i}=e,{element:n}=i;let s=Ct.get(e);void 0===s&&(n.setAttribute("class",i.strings.join(" ")),Ct.set(e,s=new Set));const r=n.classList||new xt(n);s.forEach(e=>{e in t||(r.remove(e),s.delete(e))});for(const e in t){const i=t[e];i!=s.has(e)&&(i?(r.add(e),s.add(e)):(r.remove(e),s.delete(e)))}"function"==typeof r.commit&&r.commit()},(...t)=>{const e=Pt(...t);return D.set(e,!0),e});var Pt,Et,Mt,Tt;!function(t){let e,i;!function(t){t.LEFT="left",t.CENTER="center",t.RIGHT="right"}(e=t.AlignControls||(t.AlignControls={})),function(t){t.HEADER="header",t.INSIDE="inside"}(i=t.Name||(t.Name={}))}(Et||(Et={})),function(t){t.UP="up",t.DOWN="down"}(Mt||(Mt={})),function(t){t.AM="AM",t.PM="PM"}(Tt||(Tt={}));const At=Et.AlignControls.CENTER,$t=Et.Name.HEADER;class kt{constructor(t,e,i){this._value=t,this._step=e,this._limit=i}get value(){return this._value}setStringValue(t){this.isValidString(t)&&this.setValue(parseInt(t))}stepUpdate(t){t===Mt.UP?this.increment():this.decrement()}toString(){return this.value<10?`0${this.value}`:this.value.toString()}increment(){this.setValue(this.value+this._step)}decrement(){this.setValue(this.value-this._step)}setValue(t){(t>=this._limit||t<0)&&(t=(t+this._limit)%this._limit),this._value=t}isValidString(t){const e=parseInt(t);return!isNaN(e)&&e>=0&&e<this._limit}}class Ot extends kt{constructor(t,e=1,i){super(t,e,Ot.VALUE_LIMIT),this.hourMode=i}get minValue(){return 12===this.hourMode?1:0}get maxValue(){return 12===this.hourMode?12:Ot.VALUE_LIMIT-1}togglePeriod(){this.setValue(this.value+12)}toString(){let t;return 12===this.hourMode?(t=(this.value+12)%12,t=0===t?12:t):t=this.value,t<10?`0${t}`:t.toString()}}Ot.VALUE_LIMIT=24;class Vt extends kt{constructor(t,e=5){super(t,e,Vt.VALUE_LIMIT),this.minValue=0,this.maxValue=Vt.VALUE_LIMIT-1}}Vt.VALUE_LIMIT=60;class Dt{static error(t,e){const i=document.createElement("hui-error-card");return i.setConfig({type:"error",error:t,origConfig:e}),nt`${i}`}static headerName(t){return nt`
      <div class="time-picker-header">
        ${t}
      </div>
    `}static nestedName(t,e){return nt`<state-badge .stateObj=${e}></state-badge>
      <div class="entity-name-inside">${t}</div>`}}var Ut;let jt=Ut=class extends wt{get amClass(){return{"time-period":!0,active:this.period===Tt.AM}}get pmClass(){return{"time-period":!0,active:this.period===Tt.PM}}render(){return nt`<div class="time-period-selector">
    ...
    `}};var Ht;jt.EVENT_TOGGLE="toggle",t([ft()],jt.prototype,"period",void 0),t([ft()],jt.prototype,"mode",void 0),jt=Ut=t([mt("time-period")],jt);let It=Ht=class extends wt{render(){return nt`
      <div class="time-unit">
    ...
    `}onInputChange({target:{value:t}}){this.unit.setStringValue(t),this.emitUpdate()}onStepChangerClick(t){this.unit.stepUpdate(t),this.emitUpdate()}emitUpdate(){const t=new CustomEvent(Ht.EVENT_UPDATE);this.dispatchEvent(t)}renderStepChanger(t){return nt`
    ...
    `}};var Rt;It.EVENT_UPDATE="update",t([ft()],It.prototype,"unit",void 0),It=Ht=t([mt("time-unit")],It);let Yt=Rt=class extends wt{get entity(){return this.hass.states[this.config.entity]}get datetimeEntities(){return Object.keys(this.hass.states).filter(t=>"input_datetime"===b(t)&&!0===this.hass.states[t].attributes.has_time)}render(){var t,e,i,n,s,r,o;return nt`<div class="card-config">
      <paper-dropdown-menu
        style="width: 100%"
      ...
      <div class="side-by-side">
        ...
        >
          <paper-listbox
            slot="dropdown-content"
            .selected=${Object.values(Et.Name).indexOf(null!==(n=null===(i=this.config.layout)||void 0===i?void 0:i.name)&&void 0!==n?n:$t)}
          >
            ${Object.values(Et.Name).map(t=>nt`<paper-item>${t}</paper-item>`)}
          </paper-listbox>
        </paper-dropdown-menu>
      </div>
      <div class="side-by-side">
    ...
    `}};Yt.NUMBER_PROPERTIES=["hour_step","minute_step","hour_mode"],Yt.CONFIG_CHANGED_EVENT="config-changed",t([ft({type:Object})],Yt.prototype,"hass",void 0),t([ft()],Yt.prototype,"config",void 0),Yt=Rt=t([mt("time-picker-card-editor")],Yt),console.info("%c  TIME-PICKER-CARD  \n%c  Version 0.1.1    ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"time-picker-card",name:"Time Picker Card",description:"A Time Picker card for setting the time value of Input Datetime entities."});let Lt=class extends wt{get entity(){return this.hass.states[this.config.entity]}get hasNameInHeader(){var t,e;return Boolean(this.name)&&!1===Boolean(null===(t=this.config.hide)||void 0===t?void 0:t.name)&&(null===(e=this.config.layout)||void 0===e?void 0:e.name)!==Et.Name.INSIDE}get hasNameInside(){var t,e;return Boolean(this.name)&&!1===Boolean(null===(t=this.config.hide)||void 0===t?void 0:t.name)&&(null===(e=this.config.layout)||void 0===e?void 0:e.name)===Et.Name.INSIDE}get name(){var t;return this.config.name||(null===(t=this.entity)||void 0===t?void 0:t.attributes.friendly_name)}get shouldShowPeriod(){return 12===this.config.hour_mode}get layoutAlign(){var t,e;return null!==(e=null===(t=this.config.layout)||void 0===t?void 0:t.align_controls)&&void 0!==e?e:At}get rowClass(){return{"time-picker-row":!0,"with-header-name":this.hasNameInHeader}}get contentClass(){return{"time-picker-content":!0,[`layout-${this.layoutAlign}`]:!0}}render(){var t,e;if(!this.entity)return Dt.error("Entity not found",this.config);if("input_datetime"!==b(this.entity.entity_id))return Dt.error("You must set an input_datetime entity",this.config);if(!this.entity.attributes.has_time)return Dt.error("You must set an input_datetime entity that sets has_time: true",this.config);const{hour:i,minute:n}=this.entity.attributes;return this.hour=new Ot(i,this.config.hour_step,this.config.hour_mode),this.minute=new Vt(n,this.config.minute_step),this.period=this.hour.value>=12?Tt.PM:Tt.AM,nt`
      <ha-card>
        ${this.hasNameInHeader?Dt.headerName(this.name):""}
        <div class=${Nt(this.rowClass)}>
          ${this.hasNameInside?Dt.nestedName(this.name,this.entity):""}
    ...
    `}static getStubConfig(t,e){return{entity:e.find(t=>"input_datetime"===b(t))||"input_datetime.example_entity",hour_mode:24,hour_step:1,minute_step:5}}static getConfigElement(){return document.createElement("time-picker-card-editor")}};t([ft({type:Object})],Lt.prototype,"hass",void 0),t([ft()],Lt.prototype,"config",void 0),t([ft()],Lt.prototype,"hour",void 0),t([ft()],Lt.prototype,"minute",void 0),t([ft()],Lt.prototype,"period",void 0),Lt=t([mt("time-picker-card")],Lt);export{Lt as TimePickerCard};
